<?php
	...
	$lang['nav-about'] = "info";
	$lang['nav-team'] = "team";
	$lang['nav-treatments'] = "offres";
	$lang['nav-seminars'] = "seminaires";
	$lang['nav-contact'] = "contact";
	$lang['nav-philosophy'] = "philosophie";
	$lang['nav-work'] = "nous cherchons";
  ...
  $lang['phil-info'] = "S&auml;mtliche Dienstleistungen bieten wir auch in Erg&auml;nzung zur schulmedizinischen Behandlung an, unter anderem vor oder nach der Geburt, nach einem operativen Eingriff, bei schwerer Erkrankung jeglicher Art, nach einem Unfall, w&auml;hrend oder nach einer Chemotherapie, bei einem k&ouml;rperlichen- oder psychischen Trauma sowie in Lebenskrisen.";
	...
	/* ----- philosophy site ----- */
	$lang['philosophy-text'] = "<p class='text-p'>bellsana Gesundheitszentrum® est un centre collectif de thérapeutes situé au centre-ville (sans aucune responsabilité solidaire entre les thérapeutes ni vis-à-vis de tiers).</p>
<p class='text-p'>Nous vous proposons pour votre santé tout un éventail de conseils
 et de thérapies dans une atmosphère harmonieuse. Vous trouverez  dans notre offre variée
 l'ostéopathie, la Médecine Traditionnelle  Chinoise (acupuncture, phytothérapie, ventouses, moxibustion, guasa, qi  gong), l’homéopathie classique, le massage classique, la psychothérapie (coaching), la naturopathie ainsi que la thérapie manuelle.</p>
<p class='text-p'>Nous traitons les personnes de tout âge, avec ou sans  prescription médicale, les patients remboursés ou non par les caisses  maladie. Les coûts des différents traitements sont partiellement  remboursés (jusqu’à 80%) par les caisses mutuelles ou de médecine  complémentaire/alternative.</p>
<p class='text-p'>Nous proposons nos services en complément d’éventuels  traite-ments allopathiques traditionnels, par exemple avant ou après une  naissance, après une opération, en cas de maladies graves de tout  genre, à la suite d’un accident ou d’une chimiothérapie, lors d’un  traumatisme corporel ou psychique, ainsi que lors de crises ou phases de  vie difficiles. Vous trouverez des informations complémentaires dans  les descriptifs respectifs des différentes méthodes exercées.</p>
<p class='text-p'>Notre objectif étant d’améliorer le système de défenses  immunitaires et la qualité de vie de chacun(e) de nos patient(e)s, nous  travaillons aussi avec des médecins, instituts et laboratoires  spécialisés.</p>
<p class='text-p'>Appelez-nous, c’est avec plaisir que nous donnons également par téléphone des conseils en français, allemand, italien et anglais.</p>
...
Frei zur Mitarbeit wird ab 2015 ein sch&ouml;ner Raum mit 14m2 (Miete inkl. aller Betriebskosten wie Reinigung, Sekretariatsdienst, Internetzugang, eigene Mailadresse, EWZ, usw. 1'270.00 CHF) mit Stukkatur und altem Parkett, eigene Waschmaschine und Tumbler vorhanden.</p>
	...
	$lang['news-text'] = "<p class='text-p'>Januar 2015 - Wir vermieten einen Behandlungsraum an einen Kollegen/Kollegin oder auch an eine Kosmetikerin/Pedicure. Weiterf&uuml;hrende Informationen unter \"wir suchen\". Melden Sie sich einfach per Telefon oder Mail.</p>
	...
	/* ----- links site ----- */
	$lang['links-banner'] ="Links";
	$lang['links-text'] ="<p class='text-p'>Wir m&ouml;chten ausdr&uuml;cklich betonen, dass wir keinerlei Einfluss  auf die 				Gestaltung und die Inhalte der verlinkten Seiten haben. Deshalb  distanzieren wir uns hiermit ausdr&uuml;cklich von allen Inhalten aller verlinkten Seiten auf dieser Website und machen uns deren Inhalt nicht zu  Eigen. Diese Erkl&auml;rung gilt f&uuml;r alle auf unserer Website angebrachten  Links.</p>
			<h3 class='text-p'>THEMA: PSYCHOLOGIE ALLGEMEIN</h3>
			<p class='text-p'>
			<a target='_blank' href='http://www.sorgen-telefon.info/'>www.sorgen-telefon.info</a> - Psychologische Beratung und Lebenshilfe<br>
<a target='_blank' href='http://www.lebensgeschichten.org/borderline'>www.lebensgeschichten.org/borderline</a> - Eine fast unbekannte Krankheit<br>
<a target='_blank' href='http://www.psychotraumatologie-sipt.ch/'>www.psychotraumatologie-sipt.ch/</a> - Schweizer Institut f&uuml;r Psychotraumatologie in Winterthur&nbsp;<br>
<a target='_blank' href='http://www.psychotrauma.ch/'>www.psychotrauma.ch/</a> - Z&uuml;rcher Fachstelle f&uuml;r Psychotraumatologie ZFP<br>
...
";
	...
	$lang['footer-menu-title-3'] = "localisation";

	$lang['footer-menu-1'] = "home";
	$lang['footer-menu-2'] = "philosophie";
	$lang['footer-menu-3'] = "team";
	$lang['footer-menu-4'] = "offres";
	$lang['footer-menu-5'] = "nous cherchons";
