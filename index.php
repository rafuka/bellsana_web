<?php require("inc/header.php"); ?>
	...
	<div class="jumbotron img-slider">
		<img class="img-responsive home-img" src="img/lobby.jpg" alt="Lobby Image"/>
	</div>
		...
		<div class="row">
			<a href="#">
				<div class="col-xs-12 col-sm-6 col-md-3 info-box">
					<img src="img/1.png" alt="philosophy logo"/>
			...
			<a href="#">
				<div class="col-xs-12 col-sm-6 col-md-3 info-box">
					<img src="img/2.png" alt="services logo"/>
					<h3>Services</h3>
					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit,
						 sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
			...
			<a href="#">
				<div class="col-xs-12 col-sm-6 col-md-3 info-box">
					<img src="img/3.png" alt="seminars logo"/>
					<h3>Seminars</h3>
					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit,
						 sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
					 Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi
			...
			<a href="#">
				<div class="col-xs-12 col-sm-6 col-md-3 info-box">
					<img src="img/4.png" alt="work for us logo"/>
					<h3>Work For Us</h3>
					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit,
						 sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
					 Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi
	...
	<div class="container">
		<div class="row ">
			<div class="col-sm-6 col-md-4 team-box">
				<img src="img/t1.jpg" alt="team member"/>
			...
			<div class="col-sm-6 col-md-4 team-box">
				<img src="img/t2.jpg" alt="team member"/>
			...
			<div class="col-sm-6 col-md-4 col-sm-offset-3 col-md-offset-0 team-box">
				<img src="img/t5.jpg" alt="team member"/>
	...
	<div class="container contact-wrap">
		<div id="contact-info">
			...
			<ul>
				...
				<li><i class="fa fa-envelope"></i>&nbsp;+41(0)44 281 31 31</li>
				<li><i class="fa fa-phone"></i>&nbsp;info@bellsana.ch</li>
			</ul>
		</div>
		<div id="map">
