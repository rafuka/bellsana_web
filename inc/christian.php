...
Lebensenergie, die allen K&ouml;rperfunktionen
&uuml;bergeordnet ist. Sie durchfliesst - einen
speziellen Kreislauf bildend, durch Meridiane - unseren
 K&ouml;rper. St&ouml;rungen und Missfunktionen beruhen
  nach dieser Auffassung auf einen &ouml;rtlichen
   &Uuml;berfluss oder Mangel von Lebensenergie.
    ...
    <p class='text-p'>
      ist das Wissen um die «Vernetzung» s&auml;mtlicher
       ...
       besonderen Art von reflektorischer Beziehung zu
       bestimmten K&ouml;rperteilen und Organen. Es k&ouml;nnen
       auch Hinweise auf psychosomatische St&ouml;rungen
       erkannt werden.
    </p>
    ";
    ...
    $text2 = "<h3>KLASSISCHE VOLL- UND TEILMASSAGE</h3>
      <p class='text-p'>
       ...
       m&ouml;glichen Griffen und der Intensit&auml;t des
       Massierens die optimale «Mischung» f&uuml;r den
      ...
      <p class='text-p'>
        ...
        durch die Magnetfeldtherapie normale Funktionen
         des K&ouml;rpers aktiviert und verbessert werden.
          Somit ist diese Therapie eine der
          nat&uuml;rlichsten und effizientesten
