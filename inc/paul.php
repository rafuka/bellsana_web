<?php
  ...
  $text1 = "<h2>Was ist mein Anliegen?</h2>
        ...
        <p class='text-p'>Mit Hilfe der  Osteopressurtechnik  werden die &uuml;berreizten Schmerzrezeptoren der Muskeln, Sehnen und Faszien herunter geregelt, bis ein spannungsfreier Zustand erreicht ist. So ist es m&ouml;glich, dass selbst therapieresistente Schmerzen an ihrer Ursache behandelt werden und verbl&uuml;ffend schnell verschwinden, ohne Medikamente oder Operationen auf vollkommen nat&uuml;rliche Weise.</p>
        <p class='text-p'>Die  LNB Engpassdehnungen  werden grunds&auml;tzlich im Anschluss an die Osteopressur angeleitet. Sie setzen die n&ouml;tigen Dehnungs-, Kr&auml;ftigungs- und Ansteuerungsreize an den Problemstellen. Es wird das Gleichgewicht der Muskeln und Faszien wiederhergestellt und die Schmerzfreiheit nachhaltig gew&auml;hrleistet.</p>
        <p class='text-p'>Die Bewegungslehre  LNB Motion  ist ein medical fitness Gruppentraining. Dieses erm&ouml;glicht schrittweise einen immer h&ouml;heren Bewegungsumfang, bis hin zur Ansteuerung aller Muskeln und Gelenke in den von der Natur vorgesehenen Bewegungsm&ouml;glichkeiten (die 100% Bewegung). Damit wird das Herz-Kreislaufsystem, der Stoffwechsel und die Entgiftungsleistung des K&ouml;rpers optimiert.</p>
        ...
        <p class='text-p'>* (Bindegewebsh&uuml;lle um Organe, Muskeln und Gef&auml;sse)</p>
    ";

    $text2 = "
        <h3 class='text-p'>Bei welchen Problemen kann ich helfen?</h3>
        <p class='text-p'>Grunds&auml;tzlich bei allen Schmerz- und Spannungszust&auml;nden des Organismus. Aber auch bei bevorstehenden Operationen, Schmerzen nach Operationen oder durch k&uuml;nstliche Gelenke.</p>
        <ul class='text-p'>
        ...
        <h3 class='text-p'>Wer &uuml;bernimmt die Kosten?</h3>
        <p class='text-p'>Ich bin bei ASCA und EMR anerkannt. <br>
        ...
        <h3 class='text-p'>Mein therapeutischer Werdegang</h3>
        <ul class='text-p'>
